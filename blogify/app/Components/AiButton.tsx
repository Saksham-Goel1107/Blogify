    ...
    >
      ...
      {showTooltip && (
        <div className="fixed bottom-[8rem] right-4 flex flex-col items-end space-y-1">
          <div className={`${darkMode?'bg-white text-black':'bg-gray-800 text-white'} text-sm px-3 py-1 rounded shadow-md whitespace-nowrap transition-opacity duration-300`}>
            💬 Ask AI
          </div>
        </div>
      )}
